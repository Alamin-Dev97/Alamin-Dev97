...
module.exports = {
 ...
 var name2 = "uff's jan 💘"; // Replace with function that retrieves the name of the user
 ...
 {
 body: `🙍‍♀️Successful pairing! ${name1}\💌Wish you two hundred years of happiness ${name2}.\—The odds are ${tile}%`,
 mentions: [
 {
 tag: `${name2}`,
 id: id2,
